...
<div  id="menu">
    <nav>
        ...
        <button class="btn btn-large">
            <a href="sign in.php"><h5><b><i class="bi bi-door-open"></i></b></h5>Sign in</a>
        </button><br>
        <button class="btn btn-large">
            <a href="log in.php"><h5><b><i class="bi bi-box-arrow-in-right"></i></b></h5>Login</a>
        </button><br>
        <br>
    </nav>
    </div></section>
...
<div class="post">
    <video src="bvs.mp4" alt="" controls="false" autoplay="autoplay" loop></video>
</div><br>
...
<div class="comment"><h4><i class="bi bi-heart"></i><i class="bi bi-chat"></i><i class="bi bi-bookmark-fill"></i></h4></div>
<div class="like"><h6>7M likes and followed by dcomics</h6><pre>
    "Crazy meets chaos in the heart of mayhem."
    #harley quinn #Harley Quinn </pre>
    <h6 class="unbold">View all 3M comments<br>Add a comment...</h6></div>


<div class="postheader"><img src="logo.jpg" alt=""><h6>_dc_comics_<i class="bi bi-three-dots"></i></h6></div> 
<div class="post">
<video src="jokvid.mp4" alt="" type="video/mp4" controls="false" autoplay="autoplay" loop></video>
</div><br>
<div class="comment"><h4><i class="bi bi-heart-fill"></i><i class="bi bi-chat"></i><i class="bi bi-bookmark"></i></h4></div>
