...
<div id="menu">
    <nav>
        ...
        <button class="btn btn-large">
            <a href="#"><h5><b><i class="bi bi-messenger"></i></b></h5>Messages</a>
        </button><br>
        <button class="btn btn-large">
        ...
        <button class="btn btn-large">
            <a href="#"><h5><b><i class="bi bi-person-circle"></i></b></h5><?php echo htmlspecialchars($_SESSION['username']); ?></a>
        </button><br>
        <?php if (isset($_SESSION['email'])): ?>
        <button class="btn btn-large">
            <a href="#"><h5><b><i class="bi bi-envelope"></i></b></h5><?php echo htmlspecialchars($_SESSION['email']); ?></a>
        </button>
        <?php endif; ?>
        <?php if (isset($_SESSION['mobno'])): ?>
        <button class="btn btn-large">
            <a href="#"><h5><b><i class="bi bi-phone"></i></b></h5><?php echo htmlspecialchars($_SESSION['mobno']); ?></a>
        </button><br>
        <?php endif; ?>
        <button class="btn btn-large">
...
<div id="homepage">
    ...
    <div class="post">
        <video src="bvs.mp4" controls loop></video>
    </div><br>
...
#DC #Gothamcity #Bruce Wayne #Dark Knight</pre>
    ...
    <h6 class="unbold">we need you batman<br>Add a comment...</h6></p></div>
...
knight  #Heath ledger
    ...
    <div class="post">
        <video src="jokvid.mp4" type="video/mp4" controls loop></video>
    </div><br>
    <div class="comment"><h4><i class="bi bi-heart-fill"></i><i class="bi bi-chat"></i><i class="bi bi-bookmark"></i></h4></div>
